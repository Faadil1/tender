...
const homeMarkup = (proof) => {
  ...
  return [
    '<section class="page page-home">',
      ...
      "</div>",
      '<section class="negative-evidence" aria-labelledby="negative-evidence-title">',
        '<div class="negative-evidence-lead">',
          '<p class="kicker">Real failure that shaped Tender</p>',
          '<h2 id="negative-evidence-title">A valid retry produced duplicate economic effects.</h2>',
          '<p>On 2025-12-03, a retried Stripe <code>invoice.paid</code> event was processed more than once in a production billing system.</p>',
          '<a href="https://tanstackship.com/blog/postmortem-stripe-webhook-duplicate-delivery" target="_blank" rel="noreferrer">Read the production postmortem ↗</a>',
        '</div>',
        '<div class="negative-evidence-grid">',
          '<div><span>Signal</span><strong>Retries are normal</strong><small>At-least-once delivery makes duplicate delivery part of the operating reality.</small></div>',
          '<div><span>Negative event</span><strong>18 accounts double-credited</strong><small>Two subscriptions were also downgraded incorrectly.</small></div>',
          '<div><span>Impact</span><strong>$1,247 duplicate credits</strong><small>Reported duplicate credits were reversed; support and repair work followed.</small></div>',
          '<div><span>Lesson</span><strong>Valid ≠ economically new</strong><small>Authenticity and delivery identity cannot define economic novelty.</small></div>',
          '<div><span>Tender response</span><strong>Same economics → same claim</strong><small>Replay returns the existing settlement; changed economics require new acceptance.</small></div>',
        '</div>',
      '</section>',
      '<section class="live-integration-proof" aria-labelledby="live-integration-title">',
        '<div class="live-integration-copy">',
          '<p class="kicker">Valid Until · named live integration</p>',
          '<h2 id="live-integration-title">A real project. A distinct KeeperHub settlement.</h2>',
          '<p>Tender bound accepted work from the deployed Valid Until product to a new economic claim, settled it through KeeperHub, then replayed the same obligation with no additional execution or movement.</p>',
          '<div class="action-row">',
            '<a class="button proof" href="https://valid-until-agent-os.pages.dev" target="_blank" rel="noreferrer">Open Valid Until</a>',
            '<a class="button quiet" href="https://sepolia.basescan.org/tx/0x5ee526ba2c5c630e58f9b5c0de53c24ffb0e77d83e85a78c1b3038365f42bb5b" target="_blank" rel="noreferrer">View settlement</a>',
          '</div>',
        '</div>',
        '<div class="live-integration-register">',
          '<div><span>Accepted work</span><strong>aeec4ed</strong><small>Bind exact action into execution validity contract</small></div>',
          '<div><span>Tender Claim</span><strong>tclaim_b5b5…</strong><small>distinct economic identity</small></div>',
          '<div><span>KeeperHub</span><strong>50m417t2…</strong><small>distinct execution</small></div>',
          '<div><span>Replay</span><strong>Δ 0 · $0</strong><small>ALREADY_SETTLED</small></div>',
        '</div>',
      '</section>',
