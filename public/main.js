...
const homeMarkup = (proof) => {
  ...
  return [
    '<section class="page page-home">',
      ...
      "</section>",
      '<section class="reality-check" aria-label="Concrete negative evidence">',
        '<div class="reality-copy">',
          '<p class="kicker">Real failure &gt; fake success</p>',
          '<h2>One retry. Same event. Two economic effects.</h2>',
          '<p>A 2025 production postmortem reports that a retried payment webhook was processed twice: 18 accounts received duplicate credits, 2 subscriptions were downgraded incorrectly, and $1,247 in duplicate credits had to be reversed.</p>',
          '<a class="reality-source" href="https://tanstackship.com/blog/postmortem-stripe-webhook-duplicate-delivery" target="_blank" rel="noreferrer">Read the production postmortem ↗</a>',
        "</div>",
        '<div class="reality-register">',
          '<div><span>Signal</span><strong>Retries and redelivery are normal system behavior.</strong></div>',
          '<div class="impact"><span>Impact</span><strong>18 duplicate credits · 2 downgrades · $1,247 reversed</strong></div>',
          '<div><span>Lesson</span><strong>Delivery identity is not economic identity.</strong></div>',
          '<div class="response"><span>Tender response</span><strong>Same obligation → same claim → replay moves $0.</strong></div>',
        "</div>",
      "</section>",
